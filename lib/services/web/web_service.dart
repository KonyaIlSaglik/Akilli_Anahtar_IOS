...
class WebService {
  ...
  static Future<KullaniciGirisResult?> kullaniciGiris(
    ...
    return KullaniciGirisResult.fromXML(xmlElement);
  }

  static Future<List<KullaniciKapiResult>?> kullaniciKapi(int userId) async {
    var uri = Uri.parse(url);
    var client = http.Client();
    var body =
        '''<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:tem="http://tempuri.org/">
    ...
    return KullaniciKapiResult.fromXMLList(xmlElement);
  }

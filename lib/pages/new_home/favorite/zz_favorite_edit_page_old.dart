...
class FavoriteEditPageOld extends StatefulWidget {
  const FavoriteEditPageOld({super.key});

  @override
  State<FavoriteEditPageOld> createState() => _FavoriteEditPageState();
}

class _FavoriteEditPageState extends State<FavoriteEditPageOld> {

...
class SocialUserUpdatePage extends StatefulWidget {
  const SocialUserUpdatePage({super.key});

  @override
  State<SocialUserUpdatePage> createState() => _SocialUserUpdatePageState();
}

class _SocialUserUpdatePageState extends State<SocialUserUpdatePage>
